...
The Linux Debian/Astra package sets INTERCHANGE_QT_API=PyQt5 so the
package-managed Qt5 runtime is used deterministically.
"""
import os
...
def _load_pyside6():
    ...
    from PySide6.QtWidgets import (
        ...
        QAbstractItemView, QProgressBar, QDialog, QSpinBox, QLineEdit,
        QFormLayout
    )
    return locals()
